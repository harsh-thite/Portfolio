...
const projects = [
  {
    title: "Project One",
    description: "A brief description of your amazing project and what technologies were used.",
      ...
      <div className="container mx-auto px-4">
        ...
        <FadeIn>
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4">Convinced to contact me?</h2>
            <Link href="/contact">
              <motion.button
